...
bosh add-blob ${DIR}/aci-containers-controller_1.2.0~trusty*_amd64.deb aci-cf-controller/aci-containers-controller_1.2.0~trusty_amd64.deb

#bosh add-blob ${DIR}/aci-containers-host-agent aci-cf-host-agent/aci-containers-host-agent
bosh add-blob ${DIR}/aci-containers-host-agent_1.2.0~trusty*_amd64.deb aci-cf-host-agent/aci-containers-host-agent_1.2.0~trusty_amd64.deb
...
bosh add-blob ${DIR}/opflex-agent-cni_1.2.0~trusty*_amd64.deb opflex-cni/opflex-agent-cni_1.2.0~trusty_amd64.deb
